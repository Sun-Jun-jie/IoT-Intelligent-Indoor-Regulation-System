...
#include <memory>
#include "../QT_aliyun_demo_sjj/mqtt/qmqtt_socket_p.h"
...
QT_INIT_METAOBJECT const QMetaObject QMQTT::Socket::staticMetaObject = { {
    QMetaObject::SuperData::link<SocketInterface::staticMetaObject>(),
    qt_meta_stringdata_QMQTT__Socket.data,
    qt_meta_data_QMQTT__Socket,
    qt_static_metacall,
    nullptr,
    nullptr
} };
