...
#include <memory>
#include "../QT_aliyun_demo_sjj/mqtt/qmqtt_ssl_socket_p.h"
...
QT_INIT_METAOBJECT const QMetaObject QMQTT::SslSocket::staticMetaObject = { {
    QMetaObject::SuperData::link<SocketInterface::staticMetaObject>(),
    qt_meta_stringdata_QMQTT__SslSocket.data,
    qt_meta_data_QMQTT__SslSocket,
    qt_static_metacall,
    nullptr,
    nullptr
} };
